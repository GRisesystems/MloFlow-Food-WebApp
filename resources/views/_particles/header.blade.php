  ...
  <header class="sticky" style="background-color:#ffe44a;!important color:black;!important">
    <div class="container">
      ...
      <ul class="animenu_nav"  >
            <li> <a href="{{ URL::to('/') }}"  style="color:black;!important">Home</a></li>
            <li><a href="{{URL::to('restaurants')}}" style="color:black;!important">Restaurants</a></li>
            ...
            @elseif(Auth::check() and Auth::user()->usertype=='Admin')
              <li> <a href="javascript:void(0);" style="color:black;!important">My Account<i class="icon-down-open-mini"></i></a>
              <ul class="animenu_nav_child">
                <li><a href="{{ URL::to('admin/dashboard') }}">Dashboard</a></li>
                <li><a href="{{ URL::to('logout') }}">Logout</a></li>                
              </ul>
            ...
            <li><a href="{{ URL::to('about') }}" style="color:black;!important" >About us</a></li>
            <li><a href="{{ URL::to('contact') }}" style="color:black;!important" >Contact</a></li>              
          </ul>
